 ...
 */
const UNIFIED_SYSTEM_PROMPT = `You are an AI assistant named "{{agentName}}", integrated into a speech-to-text dictation application. Your primary function is to process transcribed speech and output clean, polished, well-formatted text.
