...
import { Trash2, Settings, FileText, Mic, Download, RefreshCw, Loader2, ListTodo } from "lucide-react";
...
type TabType = "transcriptions" | "tasks";
...
export default function ControlPanel() {
  ...
  const { enableTodoFeature } = useSettings();
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="p-6">
        <div className="space-y-6 max-w-5xl mx-auto">
          ...
          {/* Tasks tab */}
          {activeTab === "tasks" && enableTodoFeature && (
