    ...
    return (
      <div className="space-y-3">
        ...
        <div className="bg-warning/5 p-2.5 rounded border border-warning/20">
          <p className="text-3xs text-warning text-center leading-snug">
    ...
    return (
      <div className="space-y-3">
        <button
          type="button"
          onClick={handleBack}
          className="text-3xs text-muted-foreground hover:text-foreground transition-colors flex items-center gap-0.5"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-2">
          ...
          {authMode === "sign-up" && (
            <p className="text-4xs text-muted-foreground/70 leading-tight">
          ...
          {authMode === "sign-in" && (
            <button
              ...
              className="text-3xs text-primary hover:text-primary/80 transition-colors text-left"
              disabled={isSubmitting}
            >
        ...
        <div className="text-center">
          <button
            ...
            className="text-3xs text-muted-foreground/70 hover:text-foreground transition-colors"
            disabled={isSubmitting}
          >
            {authMode === "sign-in" ? (
              <>
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-4xs font-medium text-muted-foreground/40 uppercase tracking-widest px-1">
          {t("auth.common.or")}
        </span>
        <div className="flex-1 h-px bg-border/50" />
      </div>
      ...
      <p className="text-3xs text-muted-foreground/80 leading-tight text-center">
        {t("auth.legal.prefix")}{" "}
        <a
