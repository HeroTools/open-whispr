      ...
      <div className="space-y-8">
        <div className="text-center">
          ...
          <p className="text-neutral-500 text-sm leading-relaxed max-w-sm mx-auto">
            Account sync is not configured for this installation. You can still use OpenWhispr locally.
          </p>
        </div>

        <div className="bg-amber-50/80 backdrop-blur-sm p-4 rounded-xl border border-amber-200/50">
          <p className="text-sm text-amber-700 text-center">
            To enable accounts, set <code className="font-mono text-xs bg-amber-100 px-1.5 py-0.5 rounded">VITE_NEON_AUTH_URL</code> in your .env file.
          </p>
        </div>
