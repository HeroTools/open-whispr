  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "dark:bg-[oklch(0.155_0.008_270)] dark:border-[oklch(0.25_0.008_270)] dark:shadow-[0_24px_48px_-12px_oklch(0_0_0/0.5)]",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full opacity-50 ring-offset-background transition-all hover:opacity-100 hover:bg-muted/50 dark:hover:bg-[oklch(0.20_0.012_270)] focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none p-1.5">
