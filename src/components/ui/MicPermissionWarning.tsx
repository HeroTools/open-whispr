  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <p className="flex-1 text-2xs text-amber-700 dark:text-warning/90 leading-snug">
        ...
        <div className="flex items-center gap-1 shrink-0">
          <Button
            ...
            className="h-6 px-2 text-3xs text-amber-700 hover:text-amber-800 hover:bg-amber-100 dark:text-warning dark:hover:text-warning dark:hover:bg-warning/10"
          >
            {config.soundLabel}
          </Button>
