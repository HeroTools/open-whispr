  ...
  return (
    <div className="space-y-3">
      ...
      >
        <div
          className={cn(
            "absolute top-1 bottom-1 w-[calc(50%-4px)] rounded-lg bg-card shadow-sm transition-transform duration-200 ease-out",
        ...
        <button
          ...
          className={cn(
            "relative z-10 flex-1 flex flex-col items-center gap-1 px-4 py-3 rounded-lg transition-colors duration-200",
