    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="bg-muted border rounded-lg p-4 font-mono text-sm max-h-96 overflow-y-auto">
  ...
  const renderEditPrompt = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-amber-600 dark:text-amber-300 mb-6">
  ...
  const renderTestPlayground = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
            <TestTube className="w-5 h-5 text-green-700 dark:text-green-400" />
            Test Your Prompt
          </h3>
          <p className="text-sm text-muted-foreground mb-6">
